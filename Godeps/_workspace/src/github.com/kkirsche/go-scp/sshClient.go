...
import (
	"bytes"
	"fmt"
	"github.com/kkirsche/go-nessus/Godeps/_workspace/src/golang.org/x/crypto/ssh"
	"github.com/kkirsche/go-nessus/Godeps/_workspace/src/golang.org/x/crypto/ssh/agent"
	"io"
	"io/ioutil"
	"log"
	"net"
